...
const TeamArea = ({bg_style}) => {
    return (
        <>
           <div className={`tp-team-area ${bg_style ? "grey-bg pt-120" : "blue-bg"} pt-95 pb-95`}>   
                     ...
                     <div className="row align-items-end">
                        <div className="col-xl-6 col-lg-6 col-md-6">
                           <div className={`tp-team-section-box ${bg_style && "text-center text-sm-start"}`}> 
                              ...
                              <h3 className={`${bg_style ? "tp-section-title mb-0 text-black" : "tp-section-title-7"}`}>{title}</h3>
                           </div>
                        </div>
                        {bg_style ?
                           <div className="col-xl-6 col-lg-6 col-md-6">
