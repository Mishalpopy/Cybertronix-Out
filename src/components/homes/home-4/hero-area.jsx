...
const hero_content = {
    ...
    title: <>
    <span><span className='child'>Transforming Tech</span></span>{" "}
    <span><span className='child'>with 50 Years</span></span>{" "}
    <span><span className='child'>of Excellence</span></span>
    </>,
