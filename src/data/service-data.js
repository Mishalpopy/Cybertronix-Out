...
import icon_3 from "../../public/assets/img/service/sv-icon-4-3_1.png"
...
const  service_data = [
    ...
    // for home 04
    {
        ...
        icon: icon_1,
        img: icon_1,
        title: "CCTV, Gate Barrier & Access Control Systems",
        sub_title: "Safety & Security",
        cls: "1",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".9s",
    },
    {
        ...
        icon: icon_2,
        img: icon_2,
        title: "Servers, Storage, UPS & Power Backups",
    ...
    },
    {
        ...
        icon: icon_3,
        img: icon_3,
        title: <>Biometrics & Intrusion Detection Systems</>,
        sub_title: "Automation Solutions",
        cls: "3",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".9s",
    },
    {
        ...
        icon: icon_4,
        img: icon_4,
        title: "Networking & Wireless Communication",
        sub_title: "Networking Solution",
        cls: "4",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".9s",
    },
